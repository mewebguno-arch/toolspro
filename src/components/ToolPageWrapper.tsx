...
export const ToolPageWrapper: React.FC<ToolPageWrapperProps> = ({
  ...
  return (
    <div id="tool-page-layout" className="min-h-screen bg-background dark:bg-[#0F0F1A] flex flex-col justify-between transition-colors duration-300 relative overflow-hidden">
      ...
      {/* Ambient Blur decorative elements - hidden on mobile to avoid graphics tearing */}
      <div className="hidden md:block absolute top-10 left-[10%] w-72 h-72 bg-[#6C63FF]/10 dark:bg-[#6C63FF]/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="hidden md:block absolute bottom-20 right-[15%] w-80 h-80 bg-[#FF6584]/15 dark:bg-[#FF6584]/5 rounded-full blur-[120px] pointer-events-none" />
