            ...
            <div className="bg-background dark:bg-[#0F0F1A] border border-border dark:border-[#2D2D45]/40 p-5 rounded-2xl">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                ...
                <div className="flex-1 max-w-md flex items-center gap-4">
                  ...
                  />
                  <span className="font-mono font-bold text-sm bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 border border-indigo-100/50 dark:border-indigo-900/30 px-3 py-1 rounded-lg">
                    {quality}%
                  </span>
                </div>
              </div>
